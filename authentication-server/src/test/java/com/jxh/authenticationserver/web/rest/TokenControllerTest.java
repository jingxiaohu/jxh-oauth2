package com.jxh.authenticationserver.web.rest;

import com.jxh.authenticationserver.AuthenticationServerApplication;
...
public class TokenControllerTest {
    ...
    public void getToken() throws Exception {
        ...
        map.put("username", Collections.singletonList("jingxiaohu"));
        map.put("password", Collections.singletonList("111111"));
